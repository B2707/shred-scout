...
/**
 * Fetches all products from a Shopify store via the public products.json endpoint.
 *
 * Paginates with `?limit=250&page=N` until the products array is empty.
 * All HTTP is delegated to the RequestPipeline (rate limiting + retry handled there).
 *
 ...
 * @returns All ShopifyProduct records from the store
 * @throws Error if any page request fails after retries
 */
