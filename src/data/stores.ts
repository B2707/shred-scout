...
const EMBEDDED_DEFAULTS: StoreEntry[] = [
  ...
  { name: 'jones', baseUrl: 'https://www.jonessnowboards.com', type: 'shopify' },
  { name: 'nitro', baseUrl: 'https://www.nitrosnowboards.com', type: 'shopify' },
  { name: 'roxy', baseUrl: 'https://www.roxy.com', type: 'shopify' },
  { name: 'springbreak', baseUrl: 'https://www.springbreaksnowboards.com', type: 'shopify' },
